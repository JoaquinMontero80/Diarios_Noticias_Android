...
public class LectorRssTecnologia extends AsyncTask<Void, Void, Void>
{
    ...
    String direccion  = ConstantesDiarios.RSS_VANGUARDIATECNOLOGIA;
    // Trabajar con la red
    URL url;
    ProgressDialog progressDialog;

    // Al constructor le añado el recyclerView como segundo parametro
    public LectorRssTecnologia(Context context, RecyclerView recyclerview) {
