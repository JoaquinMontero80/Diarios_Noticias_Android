...
import com.jobeanda.miproyecto.ui.internacionales.network.GetDataServiceRest;
...
public class ActividadInternacionalesResto extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        GetDataServiceRest service = RetrofitClientInstance.getRetrofitInstance().create(GetDataServiceRest.class);
