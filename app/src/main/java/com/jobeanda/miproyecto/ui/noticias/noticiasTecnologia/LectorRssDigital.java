...
public class LectorRssDigital extends AsyncTask<Void, Void, Void>
{
    ...
    String direccion  = ConstantesDiarios.RSS_DIGITALTREND;
    // Trabajar con la red
    URL url;
    ProgressDialog progressDialog;

    // Al constructor le añado el recyclerView como segundo parametro
    public LectorRssDigital(Context context, RecyclerView recyclerview) {
