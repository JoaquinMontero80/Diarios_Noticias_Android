...
public class LectorRssDeportivas extends AsyncTask<Void, Void, Void>
{
    // Creo ArrayList donde voy a añadir los atributos de clase Noticia
    ArrayList<Noticia> noticiasMarca= new ArrayList<>();
    ...
    String direccion  = ConstantesDiarios.RSS_MARCA;
    ...
    public LectorRssDeportivas(Context context, RecyclerView recyclerview) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        AdapterNoticias adaptadorNoticias = new AdapterNoticias(noticiasMarca, context);
