...
public class LectorRssDeportivasAS extends AsyncTask<Void, Void, Void>
{
    ...
    String direccion  = ConstantesDiarios.RSS_AS;
    // Trabajar con la red
    URL url;
    ProgressDialog progressDialog;

    // Al constructor le añado el recyclerView como segundo parametro
    public LectorRssDeportivasAS(Context context, RecyclerView recyclerview) {
    ...
    // Se ejecutará antes del código principal de nuestra tarea. Se suele utilizar para preparar la ejecución de la tarea,
