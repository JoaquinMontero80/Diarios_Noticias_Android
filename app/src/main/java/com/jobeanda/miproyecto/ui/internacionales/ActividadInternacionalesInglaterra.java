...
import com.jobeanda.miproyecto.ui.internacionales.network.GetDataServiceIng;
...
public class ActividadInternacionalesInglaterra extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        GetDataServiceIng service = RetrofitClientInstance.getRetrofitInstance().create(GetDataServiceIng.class);
