...
import com.jobeanda.miproyecto.ui.internacionales.network.GetDataServiceIta;
...
public class ActividadInternacionalesItalia extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        GetDataServiceIta service = RetrofitClientInstance.getRetrofitInstance().create(GetDataServiceIta.class);
