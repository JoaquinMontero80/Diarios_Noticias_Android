...
public class LectorRssMeneame extends AsyncTask<Void, Void, Void>
{
    ...
    String direccion  = ConstantesDiarios.RSS_MENEAME;
    // Trabajar con la red
    URL url;
    ProgressDialog progressDialog;

    // Al constructor le añado el recyclerView como segundo parametro
    public LectorRssMeneame(Context context, RecyclerView recyclerview) {
        ...
        if(data!=null)
        {
            ...
            for(int i=0; i<items.getLength(); i++)
            {
             ...
             /*           else if(actual.getNodeName().equalsIgnoreCase("content:encoded"))
                        ...
                        else if(actual.getNodeName().equalsIgnoreCase("media:thumbnail"))
                        {
