...
public class ActividadNoticiasDeportivasAs extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LectorRssDeportivasAS lectorRssAs = new LectorRssDeportivasAS(this, recyclerViewNoticias);
        lectorRssAs.execute();
