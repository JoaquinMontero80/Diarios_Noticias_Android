...
import com.jobeanda.miproyecto.ui.internacionales.network.GetDataServiceFra;
...
public class ActividadInternacionalesFrancia extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        GetDataServiceFra service = RetrofitClientInstance.getRetrofitInstance().create(GetDataServiceFra.class);
