...
public class ActividadNoticiasConfidencial extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LectorRssConfidencial lectorRss = new LectorRssConfidencial(this, recyclerViewNoticias);
        lectorRss.execute();
    }
}